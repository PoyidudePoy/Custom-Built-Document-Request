                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="student_form" data-parsley-validate="" novalidate="" method="POST">
                                               ...
                                               <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Grade level</label>
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <select data-parsley-type="alphanum" type="text" id="year_level" required="" placeholder="" class="form-control">
                                                           <option value="">&larr; Grade Level &rarr;</option>
                                               ...
                                               <div class="form-group row">
                                                ...
                                                <div class="form-group row text-right">
                                                    <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                        <button  class="btn btn-space btn-success">Submit</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
